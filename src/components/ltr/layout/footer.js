...
const Footer = () => {
  ...
  return (
    <>
      ...
      {/* START FOOTER */}
      <footer
        className="main-footer position-relative overflow-hidden"
        style={{
            ...
            <div className="col-sm-6 col-lg-3 footer-box">
              <div className="text-center text-lg-start">
                ...
                <p
                  ...
                  style={{ lineHeight: "1.3", fontSize: "0.8rem" }}
                >
                  Delivering timely and trusted news stories from Kerala and
                  beyond, keeping you informed with the latest updates and
                  breaking news.
                </p>
              </div>
            </div>
            ...
            <div className="col-sm-6 col-lg-3 footer-box">
              ...
              <ul className="list-unstyled m-0">
                {categories.length > 0 ? (
                  ...
                  <li className="text-white-50" style={{ fontSize: "0.85rem" }}>
                    No categories found
                  </li>
                )}
              </ul>
          ...
          <div className="row align-items-center">
            <div className="col-md-4 text-center text-md-start">
              <div className="text-white-50" style={{ fontSize: "0.85rem" }}>
                © 2025 <strong className="text-white">Outline Kerala</strong>.
                All rights reserved.
              </div>
            </div>
      ...
      <div className="text-white-50" style={{ fontSize: "0.85rem" }}>
        ...
        <a
          href="https://rcubeventures.co.in/"
          target="_blank"
          rel="noopener noreferrer"
          className="text-white text-decoration-none d-inline-flex align-items-center group"
