  ...
  return (
    <Layout>
      ...
      <main className="page_main_wrapper">
        <div className="team about-content mt-4">
          <div className="container">
            <div className="about-title">
              <h1>Privacy Policy</h1>
              <h3>Outline Kerala</h3>
            ...
            <div className="about-title">
              ...
              <ul>
                ...
                <li>
                  ...
                  "We", "Us" or "Our" in this Agreement) refers to Outline
                  Kerala.
                </li>
                <li>
            ...
            <div className="about-title">
              ...
              <ul>
                <li>By email: outlinekerala@gmail.com</li>
                <li>By phone number: 7736417771</li>
              </ul>
            </div>
          </div>
        </div>
